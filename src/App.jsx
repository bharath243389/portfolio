  ...
  return <main><a className="skip" href="#content">Skip to content</a>
    ...
    <div id="content"><section id="about" className="section about"><span className="about-coords" aria-hidden="true">N 18° · W 63°</span>
      ...
      <MotionDiv className="about-copy" initial={reduced ? false : { opacity: 0, y: 24 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true, amount: 0.4 }} transition={{ duration: .8, ease: [0.16, 1, 0.3, 1], delay: .12 }}>
        ...
        <p className="body-copy">I’m <strong>{portfolio.name}</strong>, a <strong>{portfolio.role}</strong> based in <strong>{portfolio.location}</strong>. {portfolio.bio}</p>
        ...
        <div className="about-log"><img src={A + 'moon.jpeg'} alt="" aria-hidden="true" loading="lazy" /><span className="about-log-mark" aria-hidden="true">✦</span><div className="about-log-content"><b>Ship’s motto</b><p>“I build things from scratch.”</p></div><span className="about-log-coords" aria-hidden="true">LOG 01 · GRAND LINE</span></div>
      </MotionDiv>
    </section>
